...
const Edit = (props) => {
	...
	const onChangePresstext = (value) => {
		setAttributes({ presstext: value });
	};
	...
	return (
		<div {...blockProps}>
			...
			<RichText
				tagName="h3"
				placeholder={__(
					'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tincidunt massa quis fermentum scelerisque.'
				)}
				value={title}
